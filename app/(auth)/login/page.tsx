  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 flex items-center justify-center px-4 py-8 sm:py-12 relative">
      ...
      <div className="fixed inset-0 -z-10 hidden sm:block">
        <div className="absolute top-0 left-1/3 w-96 h-96 bg-blue-100 dark:bg-blue-950/20 rounded-full blur-3xl opacity-30" />
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-emerald-100 dark:bg-emerald-950/20 rounded-full blur-3xl opacity-20" />
      </div>
      ...
      <div className="w-full max-w-[400px] animate-fade-up relative z-10">
        ...
        <div className="flex flex-col items-center mb-10 sm:mb-12">
          <div className="relative mb-5">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center shadow-lg shadow-blue-500/30 dark:shadow-blue-950/50">
        ...
        <div className="bg-white dark:bg-slate-950 rounded-2xl shadow-xl dark:shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 via-blue-500 to-emerald-500" />
